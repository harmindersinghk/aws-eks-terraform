locals {
  ...
  eks_oidc_issuer_url  = var.eks_oidc_provider != null ? replace(var.eks_oidc_provider, "https://", "") : replace(data.aws_eks_cluster.eks_cluster.identity[0].oidc[0].issuer, "https://", "")
